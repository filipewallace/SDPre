...
public class Objective4Lab2 {
  public static void main(String[] args) {
    ...
    System.out.println("Please enter first decimal number you would like to add.");
    double dub1 = keyboard.nextDouble();

    System.out.println("Please enter second decimal number you would like to add.");
    ...
    System.out.println("The sum of " + num1 + " + "
                                ...
                                + num3 + " = "
                                + (num1 + num2 + num3));
    System.out.println("The sum of " + dub1 + " + "
                                    + dub2 + " + "
                                    + dub3 + " = "
                                    + (dub1 + dub2 + dub3));
